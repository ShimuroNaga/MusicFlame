...
*   **Buscador Dual:** Encuentra canciones localmente en tu dispositivo o busca en línea a través de YouTube (mediante API y Firebase).
...
*   **Audio Avanzado:** Ecualizador integrado y optimización de batería para evitar interrupciones en segundo plano.

### 🤖 Integración con IA (Gemini)
*   **Chat Interactivo:** Conversa directamente con el modelo de IA desde la app.
*   **Recomendaciones:** Recibe sugerencias musicales mediante *prompts* predeterminados.
*   **Envío de Pistas:** Manda hasta 200 canciones o playlists directamente a Gemini, eligiendo exactamente cuáles con un selector.
...
*   **Color de Texto Personalizado:** Además de negro/blanco, elige cualquier color con un selector de paletas o escribiendo Hex/RGBA directamente.
*   **Forma de Carátula:** Cambia el estilo de las carátulas entre cuadrado, rombo o círculo en toda la app.
*   **Interfaz:** Opción para activar o desactivar los bordes redondeados de la interfaz, e indicador de scroll (scrollbar) en las listas largas.

### 🗑️ Gestión de Archivos
*   **Papelera de Reciclaje:** Las canciones **y ahora también las playlists** eliminadas se almacenan temporalmente y se borran automáticamente tras 30 días (con opción de borrado permanente manual). Al eliminar una playlist, las canciones dentro de ella nunca se borran del dispositivo.
